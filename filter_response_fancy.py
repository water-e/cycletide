...
sdense0b = spectral_density(lambdaf,0.5*lambdac,rho,nn,q=1)
sdense1 = spectral_density(lambdaf,1.*lambdac,.9999,nn,q=1)
sdense1b = spectral_density(lambdaf,1.5*lambdac,rho,nn,q=1)
...
sdense5 = spectral_density(lambdaf,.25*lambdac,.999,nn,q=.1)
sdense6 = spectral_density(lambdaf,.125*lambdac,.99,nn,q=.1)

totaldense = sdense0+sdense0b+sdense1+sdense1b+sdense2+sdense3+sdense4+sdense5+sdense6
sdense0 = sdense0/(totaldense+1.)
sdense0b = sdense0b/(totaldense+1.)
sdense1 = sdense1/(totaldense+1.)
sdense1b = sdense1b/(totaldense+1.)
sdense2 = sdense2/(totaldense+1.)
sdense3 = sdense3/(totaldense+1.)
sdense4 = sdense4/(totaldense+1.)
sdense5 = sdense5/(totaldense+1.)
sdense6 = sdense6/(totaldense+1.)


lambdaflab = np.linspace(0,6,nsample)
plt.plot(lambdaflab,sdense0,label="sub")
plt.plot(lambdaflab,sdense0b,label="sub1")
plt.plot(lambdaflab,sdense1,label="D1",linewidth=3)
plt.plot(lambdaflab,sdense1b,label="In",linewidth=3)

plt.plot(lambdaflab,sdense2,label="D2")
plt.plot(lambdaflab,sdense3,label="D3")
plt.plot(lambdaflab,sdense4,label="D4")
plt.plot(lambdaflab,sdense5,label="D5",color=".77",linewidth=2)
plt.plot(lambdaflab,sdense5,label="sib2",color="purple",linewidth=2)
